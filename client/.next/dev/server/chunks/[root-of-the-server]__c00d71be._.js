...
"[project]/Desktop/S62-1025-Nerdvana-Express-Full-Stack-With-NextjsAnd-AWS-Azure-Supply-Chain-Loco-Verify/client/src/app/api/auth/signup/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        const { name, email, password, phone, shopName, role = __TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Role"].VENDOR } = body;
        ...
        if (role && !Object.values(__TURBOPACK__imported__module__$5b$externals$5d2f40$prisma$2f$client__$5b$external$5d$__$2840$prisma$2f$client$2c$__cjs$29$__["Role"]).includes(role)) {
            const error = new Error("Invalid role. Must be either 'VENDOR' or 'ADMIN'");
            error.name = "ValidationError";
            throw error;
        }
        // Hash password
...
//# sourceMappingURL=%5Broot-of-the-server%5D__c00d71be._.js.map